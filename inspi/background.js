...
var MEASUREMENT_ID = "G-X1HLCLWLBH";
var API_SECRET = "zuHA94jUSSKJQP8TZ1jIUg";
...
/* harmony export */ });
/* harmony import */ var _analytics_analytics__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../analytics/analytics */ "./src/analytics/analytics.ts");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./util */ "./src/background/util.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
function registerCommands() {
    registerCommand({
        command: "toggle-notes-menu",
        onCommand: function () {
            // Removed analytics tracking
            (0,_util__WEBPACK_IMPORTED_MODULE_1__.sendContentMessage)("create-note");
        },
    });
    // Removed open-full-notes command
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createContexts: () => (/* binding */ createContexts)
/* harmony export */ });
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util */ "./src/background/util.ts");

function createContexts() {
    chrome.contextMenus.removeAll();
    chrome.action.onClicked.addListener(function (tab) {
        (0,_util__WEBPACK_IMPORTED_MODULE_0__.sendContentMessage)("create-note");
    });
}
    ...
    chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
        ...
        if (tab) {
            chrome.tabs.sendMessage(tab.id, message, function (response) {
                if (chrome.runtime.lastError) {
                    console.error("Did not receieve respone");
                }
            });
        }
        else {
...
/* harmony import */ var _ApiError__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ApiError */ "./src/client/core/ApiError.ts");
/* harmony import */ var _CancelablePromise__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CancelablePromise */ "./src/client/core/CancelablePromise.ts");
var __assign = (undefined && undefined.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
...
var sendRequest = function (config, options, url, body, formData, headers, onCancel, axiosClient) { return __awaiter(void 0, void 0, void 0, function () {
    var controller, requestConfig, _i, _a, fn, error_1, axiosError;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                ...
                fn = _a[_i];
                return [4 /*yield*/, fn(requestConfig)];
            case 2:
                requestConfig = _b.sent();
                _b.label = 3;
            case 3:
                _i++;
                return [3 /*break*/, 1];
...
var catchErrorCodes = function (options, result) {
    ...
    if (!result.ok) {
        ...
        throw new _ApiError__WEBPACK_IMPORTED_MODULE_0__.ApiError(options, result, "Generic Error: status: ".concat(errorStatus, "; status text: ").concat(errorStatusText, "; body: ").concat(errorBody));
    }
};
/**
 * Request method
...
var request = function (config, options, axiosClient) {
    if (axiosClient === void 0) { axiosClient = axios__WEBPACK_IMPORTED_MODULE_2__["default"]; }
    return new _CancelablePromise__WEBPACK_IMPORTED_MODULE_1__.CancelablePromise(function (resolve, reject, onCancel) { return __awaiter(void 0, void 0, void 0, function () {
        var url_1, formData, body, headers, response, _i, _a, fn, responseBody, responseHeader, transformedBody, result, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 10, , 11]);
                    url_1 = getUrl(config, options);
                    formData = getFormData(options);
                    body = getRequestBody(options);
                    return [4 /*yield*/, getHeaders(config, options)];
                case 1:
                    headers = _b.sent();
                    if (!!onCancel.isCancelled) return [3 /*break*/, 9];
                    return [4 /*yield*/, sendRequest(config, options, url_1, body, formData, headers, onCancel, axiosClient)];
                case 2:
                    response = _b.sent();
                ...
                case 6:
                    ...
                    if (!(options.responseTransformer && isSuccess(response.status))) return [3 /*break*/, 8];
                    return [4 /*yield*/, options.responseTransformer(responseBody)];
                case 7:
                    transformedBody = _b.sent();
                    _b.label = 8;
                case 8:
                    result = {
                        url: url_1,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $AnalyticsRequest: () => (/* reexport safe */ _schemas_gen__WEBPACK_IMPORTED_MODULE_3__.$AnalyticsRequest),
/* harmony export */   $HTTPValidationError: () => (/* reexport safe */ _schemas_gen__WEBPACK_IMPORTED_MODULE_3__.$HTTPValidationError),
/* harmony export */   $Note: () => (/* reexport safe */ _schemas_gen__WEBPACK_IMPORTED_MODULE_3__.$Note),
/* harmony export */   $NoteAnalyticsRequest: () => (/* reexport safe */ _schemas_gen__WEBPACK_IMPORTED_MODULE_3__.$NoteAnalyticsRequest),
/* harmony export */   $NotesRequest: () => (/* reexport safe */ _schemas_gen__WEBPACK_IMPORTED_MODULE_3__.$NotesRequest),
/* harmony export */   $PostResponse: () => (/* reexport safe */ _schemas_gen__WEBPACK_IMPORTED_MODULE_3__.$PostResponse),
/* harmony export */   $PostsResponse: () => (/* reexport safe */ _schemas_gen__WEBPACK_IMPORTED_MODULE_3__.$PostsResponse),
/* harmony export */   $ShareResponse: () => (/* reexport safe */ _schemas_gen__WEBPACK_IMPORTED_MODULE_3__.$ShareResponse),
/* harmony export */   $Token: () => (/* reexport safe */ _schemas_gen__WEBPACK_IMPORTED_MODULE_3__.$Token),
/* harmony export */   $UserResponse: () => (/* reexport safe */ _schemas_gen__WEBPACK_IMPORTED_MODULE_3__.$UserResponse),
/* harmony export */   $ValidationError: () => (/* reexport safe */ _schemas_gen__WEBPACK_IMPORTED_MODULE_3__.$ValidationError),
/* harmony export */   ApiError: () => (/* reexport safe */ _core_ApiError__WEBPACK_IMPORTED_MODULE_0__.ApiError),
/* harmony export */   AuthService: () => (/* reexport safe */ _services_gen__WEBPACK_IMPORTED_MODULE_4__.AuthService),
/* harmony export */   BlogService: () => (/* reexport safe */ _services_gen__WEBPACK_IMPORTED_MODULE_4__.BlogService),
...
/* harmony export */   DefaultService: () => (/* reexport safe */ _services_gen__WEBPACK_IMPORTED_MODULE_4__.DefaultService),
/* harmony export */   OpenAPI: () => (/* reexport safe */ _core_OpenAPI__WEBPACK_IMPORTED_MODULE_2__.OpenAPI)
/* harmony export */ });
/* harmony import */ var _core_ApiError__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core/ApiError */ "./src/client/core/ApiError.ts");
/* harmony import */ var _core_CancelablePromise__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./core/CancelablePromise */ "./src/client/core/CancelablePromise.ts");
/* harmony import */ var _core_OpenAPI__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./core/OpenAPI */ "./src/client/core/OpenAPI.ts");
/* harmony import */ var _schemas_gen__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./schemas.gen */ "./src/client/schemas.gen.ts");
/* harmony import */ var _services_gen__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services.gen */ "./src/client/services.gen.ts");
/* harmony import */ var _types_gen__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./types.gen */ "./src/client/types.gen.ts");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $AnalyticsRequest: () => (/* binding */ $AnalyticsRequest),
/* harmony export */   $HTTPValidationError: () => (/* binding */ $HTTPValidationError),
/* harmony export */   $Note: () => (/* binding */ $Note),
/* harmony export */   $NoteAnalyticsRequest: () => (/* binding */ $NoteAnalyticsRequest),
/* harmony export */   $NotesRequest: () => (/* binding */ $NotesRequest),
/* harmony export */   $PostResponse: () => (/* binding */ $PostResponse),
/* harmony export */   $PostsResponse: () => (/* binding */ $PostsResponse),
/* harmony export */   $ShareResponse: () => (/* binding */ $ShareResponse),
...
var $AnalyticsRequest = {
    properties: {
        ...
        data: {
            '$ref': '#/components/schemas/NoteAnalyticsRequest'
        }
    },
    type: 'object',
...
var $Note = {
    ...
    type: 'object',
    required: ['x', 'y', 'text', 'url'],
    title: 'Note'
};
var $NoteAnalyticsRequest = {
    properties: {
        domain: {
            type: 'string',
            title: 'Domain'
...
/* harmony export */ });
/* harmony import */ var _core_OpenAPI__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core/OpenAPI */ "./src/client/core/OpenAPI.ts");
/* harmony import */ var _core_request__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./core/request */ "./src/client/core/request.ts");
// This file is auto-generated by @hey-api/openapi-ts
...
var DefaultService = /** @class */ (function () {
     ...
     * @throws ApiError
     */
    DefaultService.share = function (data) {
     ...
     * @throws ApiError
     */
    DefaultService.view = function (data) {
        if (data === void 0) { data = {}; }
        return (0,_core_request__WEBPACK_IMPORTED_MODULE_1__.request)(_core_OpenAPI__WEBPACK_IMPORTED_MODULE_0__.OpenAPI, {
            method: 'GET',
            url: '/share',
     ...
     * @throws ApiError
     */
    DefaultService.feedback = function () {
        return (0,_core_request__WEBPACK_IMPORTED_MODULE_1__.request)(_core_OpenAPI__WEBPACK_IMPORTED_MODULE_0__.OpenAPI, {
            method: 'GET',
            url: '/feedback'
        });
     ...
     * @throws ApiError
     */
    DefaultService.payments = function () {
        return (0,_core_request__WEBPACK_IMPORTED_MODULE_1__.request)(_core_OpenAPI__WEBPACK_IMPORTED_MODULE_0__.OpenAPI, {
            method: 'POST',
            url: '/payments'
        });
     ...
     * @throws ApiError
     */
    DefaultService.post = function (data) {
        return (0,_core_request__WEBPACK_IMPORTED_MODULE_1__.request)(_core_OpenAPI__WEBPACK_IMPORTED_MODULE_0__.OpenAPI, {
            method: 'POST',
            url: '/analytics',
            body: data.requestBody,
...
var BlogService = /** @class */ (function () {
    ...
    /**
     * Get All Posts
     * @returns PostsResponse Successful Response
     * @throws ApiError
     */
    BlogService.getAllPosts = function () {
        return (0,_core_request__WEBPACK_IMPORTED_MODULE_1__.request)(_core_OpenAPI__WEBPACK_IMPORTED_MODULE_0__.OpenAPI, {
            method: 'GET',
            url: '/posts'
        });
     ...
     * @throws ApiError
     */
    BlogService.getPost = function (data) {
        return (0,_core_request__WEBPACK_IMPORTED_MODULE_1__.request)(_core_OpenAPI__WEBPACK_IMPORTED_MODULE_0__.OpenAPI, {
            method: 'GET',
            url: '/post/{post_id}',
            path: {
...
var AuthService = /** @class */ (function () {
     ...
     * @throws ApiError
     */
    AuthService.getPaymentInfo = function (data) {
        return (0,_core_request__WEBPACK_IMPORTED_MODULE_1__.request)(_core_OpenAPI__WEBPACK_IMPORTED_MODULE_0__.OpenAPI, {
            method: 'GET',
            url: '/user',
            query: {
     ...
     * Status
     * @param data The data for the request.
     * @param data.authCookie
     * @returns unknown Successful Response
     * @throws ApiError
     */
    AuthService.status = function (data) {
        if (data === void 0) { data = {}; }
        return (0,_core_request__WEBPACK_IMPORTED_MODULE_1__.request)(_core_OpenAPI__WEBPACK_IMPORTED_MODULE_0__.OpenAPI, {
            method: 'GET',
            url: '/me',
     ...
     * @throws ApiError
     */
    AuthService.authenticateGoogleUser = function (data) {
        return (0,_core_request__WEBPACK_IMPORTED_MODULE_1__.request)(_core_OpenAPI__WEBPACK_IMPORTED_MODULE_0__.OpenAPI, {
            method: 'POST',
            url: '/auth/google',
            body: data.requestBody,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getOrCreateClientId: () => (/* binding */ getOrCreateClientId),
...
function getOrCreateClientId() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, chrome.storage.local.get("clientId")];
                case 1:
                    result = _a.sent();
                    clientId = result.clientId;
                    if (!!clientId) return [3 /*break*/, 3];
                    clientId = self.crypto.randomUUID();
                    return [4 /*yield*/, chrome.storage.local.set({ clientId: clientId })];
                case 2:
                    _a.sent();
                    _a.label = 3;
...
var SESSION_EXPIRATION_IN_MIN = 60;
function getOrCreateSessionId() {
    return __awaiter(this, void 0, void 0, function () {
        var sessionData, currentTimeInMs, durationInMin;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, chrome.storage.session.get("sessionData")];
                case 1:
                    sessionData = (_a.sent()).sessionData;
                    currentTimeInMs = Date.now();
                    if (!(sessionData && sessionData.timestamp)) return [3 /*break*/, 4];
                    durationInMin = (currentTimeInMs - sessionData.timestamp) / 60000;
                    if (!(durationInMin > SESSION_EXPIRATION_IN_MIN)) return [3 /*break*/, 2];
                    sessionData = null;
                    return [3 /*break*/, 4];
                case 2:
                    sessionData.timestamp = currentTimeInMs;
                    return [4 /*yield*/, chrome.storage.session.set({ sessionData: sessionData })];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4:
                ...
                case 5:
                    _a.sent();
                    _a.label = 6;
                case 6: return [2 /*return*/, sessionData.session_id];
            }
        });
    });
}
...
(0,_contexts__WEBPACK_IMPORTED_MODULE_0__.createContexts)();
(0,_commands__WEBPACK_IMPORTED_MODULE_1__.registerCommands)();



function getNotes(list_id) {
    return __awaiter(this, void 0, void 0, function () {
        var response, notes;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("https://pksticky.com/share?json=True&n=".concat(list_id))];
                case 1:
                    response = _a.sent();
...
chrome.runtime.onMessage.addListener(function (request, sender, res) {
    ...
    if (!cmd) {
        throw Error("Command does not exist " + key);
    }
    return cmd.call(_this, { request: request, sender: sender, res: res });
});
// Removed analytics error tracking
